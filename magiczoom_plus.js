function get_gallery_attr(goods_id, goods_attr_id)
	{		
		Ajax.call('http://www.rongkey.com/themes/68ecshopcom_360buy/js/goods.php?act=get_gallery_attr', 'id=' + goods_id + '&goods_attr_id=' + goods_attr_id , get_gallery_attr_Response, 'GET', 'JSON');
	}
...
function changeAtt(t,goods_id) {
	...
	//Ajax.call('http://www.rongkey.com/themes/68ecshopcom_360buy/js/goods.php?act=get_products_info', 'id=' + spec_arr+ '&goods_id=' + goods_id, shows_number, 'GET', 'JSON');
