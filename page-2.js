...
function autoComplete(e_NIt6) {
	if (e_NIt6) {
		Ajax["call"]('http://main.fuxiark.com/0rongkey/English/themes/68ecshopcom_360buy/js/ajax_www_68ecshop_com.php', 'act=tipword&word=' + e_NIt6, _autoComplete, 'GET', 'JSON');
	}
}
