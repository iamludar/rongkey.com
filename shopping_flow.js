...
function selectShipping(recid, suppid) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=select_shipping', 'recid=' + recid + '&suppid=' + suppid, orderShipping, 'GET', 'JSON');
...
function selectShipping_old(obj) {
	...
	var now = new Date();
	Ajax.call('http://www.rongkey.com/js/flow.php?step=select_shipping', 'shipping=' + obj.value + '&pickup=' + supportPickup, orderShippingSelectedResponse, 'GET', 'JSON');
}
...
function selectVirtualGroupPayment(obj) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=select_payment', 'payment=' + obj.value, orderSelectedResponse, 'GET', 'JSON');
}
/*******************************************************************************
 * 改变支付方式
 */
...
function handleGroupBuyShipping(obj) {
	...
	Ajax.call('http://www.rongkey.com/js/group_buy.php?act=select_shipping', 'shipping=' + obj.value, orderSelectedResponse, 'GET');
}
...
function handleGroupBuyPayment(obj) {
	...
	Ajax.call('http://www.rongkey.com/js/group_buy.php?act=select_payment', 'payment=' + obj.value, orderSelectedResponse, 'GET');
}
...
function selectPack(obj) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=select_pack', 'pack=' + aaa, orderSelectedResponse, 'GET', 'JSON');
...
function selectCard(obj) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=select_card', 'card=' + aaa, orderSelectedResponse, 'GET', 'JSON');
	/* 代码修改_end By www.68ecshop.com */
}
...
function selectInsure(needInsure) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=select_insure', 'insure=' + needInsure, orderSelectedResponse, 'GET', 'JSON');
}
...
function handleGroupBuyInsure(needInsure) {
	...
	Ajax.call('http://www.rongkey.com/js/group_buy.php?act=select_insure', 'insure=' + needInsure, orderSelectedResponse, 'GET', 'JSON');
}
...
function orderSelectedResponse(result) {
	if (result.error) {
		alert(result.error);
		location.href = 'http://www.rongkey.com/js/';
	}
...
function changeSurplus(val) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=change_surplus', 'surplus=' + val, changeSurplusResponse, 'GET', 'JSON');
}
...
function changeIntegral(val, suppid) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=change_integral', 'points=' + val + '&suppid=' + suppid, changeIntegralResponse, 'GET', 'JSON');
}
...
function changeBonus(val, suppid) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=change_bonus', 'bonus=' + val + '&suppid=' + suppid, changeBonusResponse, 'GET', 'JSON');
}
...
function validateBonus(val, suppid) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=validate_bonus', 'bonus_sn=' + val + '&suppid=' + suppid, validateBonusResponse, 'GET', 'JSON');
}
...
function changeNeedInv() {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=change_needinv', 'need_inv=' + needInv + '&inv_type=' + encodeURIComponent(invType) + '&inv_payee=' + encodeURIComponent(invPayee) + '&inv_content=' + encodeURIComponent(invContent), changeNeedInvResponse, 'GET');
}
...
function groupBuyChangeNeedInv() {
	...
	Ajax.call('http://www.rongkey.com/js/group_buy.php?act=change_needinv', 'need_idv=' + needInv + '&amp;payee=' + invPayee + '&amp;content=' + invContent, null, 'GET');
}
...
function changeOOS(obj) {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=change_oos', 'oos=' + obj.value, null, 'GET');
}
...
function check_before_submit() {
	...
	if (checkOrderForm(the_form)) {
		Ajax.call('http://www.rongkey.com/js/flow.php?step=check_surplus_open', '', is_surplus_open, 'GET', 'TEXT', true, true);
	}
	return false;
}
...
function end_input_surplus() {
	...
	Ajax.call('http://www.rongkey.com/js/flow.php?step=verify_surplus_password', 'surplus_password=' + surplus_password, check_surplus_response, 'GET', 'TEXT', true, true);
}
...
function checkOrderForm(frm) {
	...
	if (document.getElementById("ECS_SURPLUS")) {
		...
		var error = Utils.trim(Ajax.call('http://www.rongkey.com/js/flow.php?step=check_surplus', 'surplus=' + surplus, null, 'GET', 'TEXT', false));
	...
	if (document.getElementById("ECS_INTEGRAL")) {
		...
		var error = Utils.trim(Ajax.call('http://www.rongkey.com/js/flow.php?step=check_integral', 'integral=' + integral, null, 'GET', 'TEXT', false));
...
function doNewMobile() {
	...
	if (mobile_phone == '' || !Utils.isMobile(mobile_phone)) {
		...
		Ajax.call('http://www.rongkey.com/js/flow.php?act=edit_user_mobile', 'mobile_phone=' + mobile_phone, get_user_mobile, "GET", "JSON");
	}
}